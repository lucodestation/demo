var yourBrowser = {
  ...
  showTip: function () {
    ...
    div.style.font =
      "16px/1.5 PingFangSC-Regular,HelveticaNeue-Light,Helvetica Neue Light,Microsoft YaHei,sans-serif";
    ...
    div.innerHTML =
      '<p>您的浏览器版本过低！</p><p><a href="https://lucodestation.github.io/demo/get-browser/" target="_blank">下载新版浏览器</a> 以获取更好的体验。</p>';
  ...
  version: function (args) {
    ...
    version =
      version.toLowerCase() === "!ie" ? "!ie" : parseInt(version.substr(2));
    var obj = {
      "<": function (v) {
        return version < parseInt(v.substr(2));
      },
      "<=": function (v) {
        return version <= parseInt(v.substr(2));
      },
